#!/usr/bin/env python3
"""
G2P (Grapheme-to-Phoneme) script for Japanese using epitran.
...
def main():
    ...
    try:
        ...
        print(f"Error loading Japanese G2P: {e}", file=sys.stderr)
        sys.exit(1)
    ...
    with open(input_file, 'r', encoding='utf-8') as f:
        for line in f:
            ...
            try:
                ...
                if phones:
                    # Convert to a simple format (space-separated IPA)
